    ...
    components:{
            ...
            template:`
                <div class="container">
                    ...
                    <div class="container mt-4">
                        ...
                        <div class="row">
                            <div class="col-2" style="width:200px" v-for="(item,index) in searchmsg.slice(0,24)">
                        ...
                        <hr class="bg-danger" v-show="!this.search">
                        <div class="row">
                            <div class="col-2" style="width:200px" v-for="(item,index) in searchmsg.slice(24,48)">
                                <img class="card-img-top" :src="item.image" alt="Card image" style="width:100%;height:150px" :title="item.title">
                                <small>{{item.title.slice(0,11)}}</small>
                                <br >
                                <label class="card-title text-danger">￥{{item.price}}</label>
                        ...
                        <hr class="bg-danger" v-show="!this.search">
                        <div class="row">
                            <div class="col-2" style="width:200px" v-for="(item,index) in searchmsg.slice(48,60)">
                                <img class="card-img-top" :src="item.image" alt="Card image" style="width:100%;height:150px" :title="item.title">
                                <small>{{item.title.slice(0,11)}}</small>
                                <br >
                                <label class="card-title text-danger">￥{{item.price}}</label>
                        ...
                        <hr class="bg-danger" v-show="!this.search">
                        <div class="row">
                            <div class="col-2" style="width:200px" v-for="(item,index) in searchmsg.slice(60,72)">
                                <img class="card-img-top" :src="item.image" alt="Card image" style="width:100%;height:150px" :title="item.title">
                                <small>{{item.title.slice(0,11)}}</small>
                                <br >
                                <label class="card-title text-danger">￥{{item.price}}</label>
        ...
        'shopping':{
            ...
            <div class="container w-50 border fixed-top mt-5 jumbotron pre-scrollable" v-show="state.isshop">
                ...
                <div class="p-2 text-left text-dark mt-1" v-for="(item,index) in users[index].shop" :key="index">
